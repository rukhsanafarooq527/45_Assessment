...
let transportation:string[] = ['heavy scooty' ,'Honda motorcycle','Corolla car', 'Hilux','Audi'];
...
// let vehichles: string[] =['heavy scooty' ,'Honda motorcycle','Corolla car', 'Hilux','Audi']
